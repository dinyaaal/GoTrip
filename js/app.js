(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".item-accommodation__slider")) new swiper_core_Swiper(".item-accommodation__slider", {
                ...
                speed: 800,
                pagination: {
                    el: ".item-accommodation__pagination",
                    clickable: true
                },
                navigation: {
                    prevEl: ".item-accommodation__arrow-prev",
                    nextEl: ".item-accommodation__arrow-next"
                },
                on: {}
            });
            if (document.querySelector(".gallery-accommodation__slider")) new swiper_core_Swiper(".gallery-accommodation__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                speed: 800,
                pagination: {
                    el: ".gallery-accommodation__pagination",
                    type: "fraction",
                    clickable: false
                },
                breakpoints: {
...
***************************************************************************** */
        ...
        if (document.getElementById("date")) {
            ...
            var dateOpener = document.getElementById("date-opener");
            var dateInput = document.getElementById("date");
            dateOpener.addEventListener("click", (function(event) {
                event.preventDefault();
                dateInput.focus();
            }));
        }
        if (document.getElementById("date-mobile")) new index_es("#date-mobile", {
            range: true,
            inline: true,
            minDate: new Date,
            dateFormat: "MMM dd",
        ...
        if (document.querySelector(".item-popup-guests")) document.addEventListener("DOMContentLoaded", (function() {
